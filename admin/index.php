...
<script type="text/javascript">
    ...
    <head>
  <style>
    /* Round the corners of all elements */
    .widget-box {
      border-radius: 12px; /* Make corners round */
      box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1); /* Shadow effect */
      background-color: transparent;
    }

    .widget-title.bg_lg {
      background-color: #2ecc71; /* New fresh green color */
      border-radius: 12px; /* Round corners */
      color: white;
    }

    .widget-title.bg_ly {
      background-color: #e74c3c; /* New bold red color */
      border-radius: 12px; /* Round corners */
      color: white;
    }
    ...
    /* Ensure charts have enough space with rounded corners */
    #top_x_div, #top_y_div, #donutchart, #donutchart2022 {
      min-height: 300px;
      width: 100%;
      border-radius: 12px; /* Round corners */
    }

    /* Ensure proper alignment of the sidebar and content */
    .container-fluid {
      display: flex;
      flex-wrap: wrap;
    ...
    .span6 {
      flex: 0 0 48%; /* Adjust width for 2 elements per row */
      margin-bottom: 20px;
    }

    .span8 {
      flex: 0 0 65%; /* Adjust width for 1 larger element per row */
    }
  </style>
</head>
