        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='actions/delete-member.php?id=".$row['user_id']."' style='color:#F66;' onclick=\"return confirm('Are you sure you want to remove this member?');\"><i class='fas fa-trash'></i> Remove</a></div></td>
